...
export default function Routes() {
    return (
        <Stack.Navigator initialRouteName="entry">
            ...
            <Stack.Screen options={{ headerShown: false }} name="driver-signup" component={DriverSignUp} />
            <Stack.Screen options={{ headerShown: false }} name="automobile-register" component={AutomobileRegister} />
        </Stack.Navigator>
    );
}